...
DBOOL afs_administrative_metadata_equal(const afs_administrative_metadata * administrative_metadata1, const afs_administrative_metadata * administrative_metadata2)
{
    ...
    if ((administrative_metadata1->reel_id == administrative_metadata2->reel_id || strcmp(administrative_metadata1->reel_id ? administrative_metadata1->reel_id : "", administrative_metadata2->reel_id ? administrative_metadata2->reel_id : "") == 0) &&
        (administrative_metadata1->print_reel_id == administrative_metadata2->print_reel_id || strcmp(administrative_metadata1->print_reel_id ? administrative_metadata1->print_reel_id : "", administrative_metadata2->print_reel_id ? administrative_metadata2->print_reel_id : "") == 0) &&
        (administrative_metadata1->title == administrative_metadata2->title || strcmp(administrative_metadata1->title ? administrative_metadata1->title : "", administrative_metadata2->title ? administrative_metadata2->title : "") == 0) &&
        (administrative_metadata1->description == administrative_metadata2->description || strcmp(administrative_metadata1->description ? administrative_metadata1->description : "", administrative_metadata2->description ? administrative_metadata2->description : "") == 0) &&
        (administrative_metadata1->creator == administrative_metadata2->creator || strcmp(administrative_metadata1->creator ? administrative_metadata1->creator : "", administrative_metadata2->creator ? administrative_metadata2->creator : "") == 0) &&
        (administrative_metadata1->creation_date == administrative_metadata2->creation_date || strcmp(administrative_metadata1->creation_date ? administrative_metadata1->creation_date : "", administrative_metadata2->creation_date ? administrative_metadata2->creation_date : "") == 0))
    {
        return DTRUE;
    }
